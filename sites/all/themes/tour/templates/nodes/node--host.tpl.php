        ...
        <div class="singlecourse_ferimg_area">
            ...
            <div class="singlecourse_bottom">
                ...
                <span class="singlecourse_author">
                    <?php print theme('image_style', array('path' => $node->field_avatar[LANGUAGE_NONE][0]['uri'], 'style_name' => 'thumbnail')) ?><?php print _get_term_name($node->field_guidable_area[LANGUAGE_NONE]) ?><p><a href="<?php print url('contact') ?>" class="question"><?php print t('Contact') ?></a></p></span>
